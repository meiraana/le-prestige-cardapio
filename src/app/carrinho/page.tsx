...
export default function CarrinhoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F1E8] text-[#2b2118] font-sans flex flex-col justify-between overflow-x-hidden">
      ...
      <header className="bg-[#3E2A1E] text-white">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-10 py-2">
          ...
          <Link 
            href="/#cardapio"
            className="font-sans flex items-center gap-1 sm:gap-2 border-2 border-[#F5F1E8] hover:bg-white/10 text-[#F5F1E8] px-2.5 py-1.5 sm:px-4 sm:py-2 rounded-xl text-xs sm:text-sm font-medium transition-all shrink-0"
          >
      ...
      <main className="max-w-6xl mx-auto px-3 sm:px-8 py-4 sm:py-10 w-full flex-grow">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 mb-4">
          <div>
            <h2 className="font-serif text-xl sm:text-4xl font-bold text-[#3E2A1E]">
              Seu Carrinho de Compras
            </h2>
            <p className="font-sans text-xs sm:text-sm text-[#3E2A1E] mt-0.5 sm:mt-1">
              Confira seus itens antes de enviar o pedido para a cozinha.
            </p>
          </div>

          <div className="bg-[#D3C7BC] text-[#3E2A1E] font-bold text-[10px] sm:text-xs uppercase px-3 py-1.5 sm:px-4 sm:py-2 rounded-full tracking-wider self-start sm:self-auto shrink-0">
            {totalItens} {totalItens === 1 ? 'ITEM SELECIONADO' : 'ITENS SELECIONADOS'}
          </div>
        </div>

        <div className="border-b border-[#3E2A1E]/20 w-full mb-6 sm:mb-8" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-3 sm:space-y-4">
            {carrinho.length === 0 ? (
              <div className="bg-white border border-[#324A38] rounded-2xl p-6 sm:p-10 text-center">
                ...
                <p className="text-xs sm:text-sm text-[#324A38] mb-6">
                  Você ainda não escolheu nenhum prato do nosso cardápio.
                </p>
                <Link 
                  href="/#cardapio" 
                  className="inline-block bg-[#324A38] text-white text-xs font-bold uppercase tracking-wider px-6 py-3 rounded-lg hover:bg-[#25382A] transition-all"
                >
                  Explorar Cardápio
                </Link>
              </div>
              ...
              carrinho.map((item) => (
                ...
                >
                  ...
                  <div className="flex-grow min-w-0 pr-1 sm:pr-2">
                    ...
                    <span className="font-sans text-xs sm:text-sm text-[#3E2A1E] block mt-0.5 font-semibold">
                  ...
                  <div className="flex flex-col items-end justify-between self-stretch shrink-0 py-0.5">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 bg-[#DCD6CD] border border-[#324A38] rounded-full px-2 py-0.5 sm:px-2.5">
                      <button 
                      ...
                      <span className="font-bold text-[11px] sm:text-xs text-[#3E2A1E]">
                        {item.quantidade}
                      </span>
                      <button 
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-6 w-full">
            <div className="bg-white border border-[#324A38] rounded-2xl p-4 sm:p-6 shadow-sm">
              <h3 className="font-serif text-base sm:text-lg font-bold text-[#324A38] border-b border-[#3E2A1E]/20 pb-3 mb-4 uppercase tracking-wide">
                RESUMO DO PEDIDO
              </h3>

              <form onSubmit={handleEnviarPedido} className="space-y-4">
                <div>
                  <label className="block text-sm sm:text-lg font-sans text-[#3E2A1E] mb-1">
                    Seu nome completo:
                  </label>
                  <input 
                    type="text"
                    ...
                    className="w-full bg-[#ECE7DE] border border-[#324A38] rounded-xl px-3 py-2 sm:px-3.5 sm:py-2.5 font-sans text-sm sm:text-lg text-[#3E2A1E] placeholder-[#3E2A1E]/40 focus:outline-none focus:border-[#3E2A1E] transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#ECE7DE] border border-[#324A38] rounded-xl px-3 py-2 sm:px-3.5 sm:py-2.5 font-sans text-sm sm:text-lg text-[#3E2A1E] placeholder-[#3E2A1E]/40 focus:outline-none focus:border-[#3E2A1E] resize-none transition-colors"
                  />
                </div>

                <div className="border-t border-[#3E2A1E]/20 pt-2 space-y-2 text-sm sm:text-lg text-[#324A38]">
                  ...
                  <div className="border-t border-[#3E2A1E]/20 pt-3 mt-3 flex justify-between items-center">
                    <span className="font-semibold text-base sm:text-xl uppercase tracking-wider text-[#3E2A1E]">VALOR TOTAL</span>
                    <span className="font-bold text-lg sm:text-xl text-[#3E2A1E]">
